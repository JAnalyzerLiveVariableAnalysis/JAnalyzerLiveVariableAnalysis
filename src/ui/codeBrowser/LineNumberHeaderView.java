...
public class LineNumberHeaderView extends JComponent {
	...
	private final Font DEFAULT_FONT = new Font("Courier New", Font.PLAIN, 15);
	...
	protected void paintComponent(Graphics g) {
		...
		for (int i = startLineNum; i <= endLineNum; ++i) {
			...
			g.drawString(lineNum + " ", MARGIN + currentRowWidth - width - 1,
					start + 2);
			start += nlineHeight;
		}
