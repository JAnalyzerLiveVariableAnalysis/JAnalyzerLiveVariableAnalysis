 ...
 * @version 1.0
 */
public class SystemScopeMeasureDistribution extends NameScopeMeasureDistribution {

	public SystemScopeMeasureDistribution(String identifier) {
		super(identifier);
	}

	public SystemScopeMeasureDistribution(SoftwareMeasure measure) {
		super(measure);
	}

	public SystemScope[] getSystemScopeArray() {
		return (SystemScope[])scopeArray;
	}
	
	public SystemScope getSystemScope(int index) {
		return (SystemScope)getNameScope(index);
	}
	
	/**
	 * Get the index of the give system scope. If we can not find the scope, return -1.
	 */
	public int getSystemScopeIndex(SystemScope scope) {
	 ...
	 */
	public void setSystemScopeArray(SystemScope[] array) {
		scopeArray = array;
	}
	 ...
	 */
	public void setSystemScopeList(List<SystemScope> scopes) {
	 ...
	 */
	public boolean setValue(SystemScope scope, double value) {
	...
	public void printToColumn(PrintWriter writer, boolean printScope) {
		if (printScope == true) {
			writer.println("System\t" + identifier);
