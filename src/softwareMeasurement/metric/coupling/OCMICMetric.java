...
/**
 * A class to calculate the metric OCMIC
 * 
 * @author Li Jingsheng
 * @since 2015Äê9ÔÂ12ÈÕ
 * @version 1.0
 ...
 * 
 */
public class OCMICMetric extends SoftwareCouplingMetric{
	...
	public boolean calculate(SoftwareMeasure measure) {
		...
		if (!type.isInterface()) {
			...
			for (DetailedTypeDefinition other : otherTypeSet) {
				value += CouplingCalculationUtil.getNumberOfCM(structManager, type, other);
			}
		}
