 ...
 * @version 1.0
 */
public class LocalReferenceASTVisitor extends ASTVisitor {
	...
	public LocalReferenceASTVisitor(String unitFileFullName, CompilationUnit root, LocalScope bodyScope) {
